...
DIFFICULTY = {
    0: {"name": "Normal", "hpMult": 1.0, "goldMult": 1.0, "livesMod": 0, "eliteChance": 0, "speedMult": 1.0},
    1: {"name": "Fácil", "hpMult": 0.7, "goldMult": 1.2, "livesMod": 5, "eliteChance": 0, "speedMult": 0.9},
    2: {"name": "Difícil", "hpMult": 1.5, "goldMult": 0.8, "livesMod": -3, "eliteChance": 0.15, "speedMult": 1.1},
    3: {"name": "Pesadilla", "hpMult": 2.2, "goldMult": 0.6, "livesMod": -5, "eliteChance": 0.3, "speedMult": 1.2},
}

TOWER_TYPES = [
    "archer", "fire", "ice", "venom", "crossbow", "dwarf",
    "druid", "tesla", "knight", "sniper", "holy", "banner", "warlock",
    "barracks",
]

TOWERS = {
    "archer": {
        "name": "Arquero", "icon": "\U0001f3f9", "cost": 50, "element": "physical",
        ...
        "ability": {"name": "Lluvia de Flechas", "icon": "\U0001f3f9", "cd": 20,
                    "desc": "Ráfaga de flechas sobre todos los enemigos en alcance."},
    },
    "fire": {
        "name": "Mago de Fuego", "icon": "\U0001f525", "cost": 85, "element": "fire",
        ...
        "ability": {"name": "Meteorito", "icon": "\u2604\ufe0f", "cd": 26,
                    "desc": "Un meteorito arrasa la zona de mayor presión enemiga."},
    },
    "ice": {
        ...
        "ability": {"name": "Nova Glacial", "icon": "\u2744\ufe0f", "cd": 24,
                    "desc": "Onda de escarcha que congela y daña a todos los enemigos en alcance."},
    },
    "dwarf": {
        "name": "Cañón Enano", "icon": "\U0001f4a3", "cost": 120, "element": "earth",
        ...
        "ability": {"name": "Bombardeo", "icon": "\U0001f4a3", "cd": 28,
                    "desc": "Lluvia de bombas sobre los enemigos en alcance."},
    },
    "crossbow": {
        "name": "Ballestero", "icon": "\U0001f3af", "cost": 110, "element": "physical",
        ...
        "ability": {"name": "Virote Perforante", "icon": "\U0001f3af", "cd": 26,
                    "desc": "Un virote colosal atraviesa a todos los enemigos en línea."},
    },
    "venom": {
        "name": "Alquimista", "icon": "\U0001f9ea", "cost": 75, "element": "nature",
        ...
        "ability": {"name": "Nube Tóxica", "icon": "\U0001f9ea", "cd": 24,
                    "desc": "Envenena en área a todos los enemigos en alcance."},
    },
    "druid": {
        "name": "Druida", "icon": "\U0001f33f", "cost": 90, "element": "nature",
        ...
        "ability": {"name": "Emboscada", "icon": "\U0001f33f", "cd": 22,
                    "desc": "Raíces salvajes inmovilizan y dañan a los enemigos en alcance."},
    },
    "tesla": {
        ...
        "ability": {"name": "Tormenta", "icon": "\u26a1", "cd": 26,
                    "desc": "Cadena de rayos devastadora sobre muchos enemigos."},
    },
    "knight": {
        ...
        "ability": {"name": "Golpe de Escudo", "icon": "\U0001f6e1\ufe0f", "cd": 20,
                    "desc": "Empuja, aturde y daña a los enemigos cercanos."},
    },
    "sniper": {
        "name": "Francotirador", "icon": "\U0001f52d", "cost": 150, "element": "physical",
        ...
        "ability": {"name": "Tiro Letal", "icon": "\U0001f52d", "cd": 28,
                    "desc": "Disparo de precisión masivo al enemigo más avanzado."},
    },
    "holy": {
        ...
        "ability": {"name": "Purificación", "icon": "\u2728", "cd": 26,
                    "desc": "Repara torres aliadas, purifica el suelo y hiere a los corruptos."},
    },
    "banner": {
        "name": "Estandarte", "icon": "\U0001f6a9", "cost": 110, "element": "holy",
        ...
        "ability": {"name": "Grito de Guerra", "icon": "\U0001f6a9", "cd": 28,
                    "desc": "Inspira a las torres aliadas cercanas: +50% daño durante 8s."},
    },
    "warlock": {
        "name": "Cultista del Vacío", "icon": "\U0001f300", "cost": 140, "element": "void",
        ...
        "ability": {"name": "Devastación", "icon": "\U0001f300", "cd": 26,
                    "desc": "Explosión del vacío que maldice y daña a todos en alcance."},
    },
    "barracks": {
        ...
        "ability": {"name": "Refuerzos", "icon": "\u2694\ufe0f", "cd": 30,
                    "desc": "Refresca y fortalece a los soldados aliados cercanos."},
    },
}

TOWERS["archer"]["upgrades"] = [
    {"name": "Flecha Doble", "cost": 50, "damage": 20, "rate": 0.38, "targetCap": 2,
     "desc": "Dispara a dos enemigos a la vez."},
    {"name": "Flecha Perforante", "cost": 100, "damage": 28, "rate": 0.34, "pierce": 3, "targetCap": 2,
     "desc": "Las flechas atraviesan a varios enemigos."},
    {"name": "Lluvia de Flechas", "cost": 180, "damage": 38, "rate": 0.30, "pierce": 4, "targetCap": 3, "aoe": 26,
     "desc": "Ráfaga con pequeña zona de impacto."},
]
TOWERS["fire"]["upgrades"] = [
    {"name": "Bola de Fuego", "cost": 70, "damage": 34, "aoe": 52,
     "desc": "Más daño y mayor explosión."},
    {"name": "Explosión", "cost": 130, "damage": 50, "aoe": 60,
     "desc": "Incendia grandes grupos de enemigos."},
    {"name": "Meteorito", "cost": 220, "damage": 85, "aoe": 72,
     "desc": "Un meteorito arrasa la zona."},
]
TOWERS["ice"]["upgrades"] = [
    {"name": "Rayo Helado", "cost": 60, "damage": 10, "rate": 0.8,
     "desc": "Ralentiza más a sus objetivos."},
    {"name": "Escarcha", "cost": 110, "damage": 14, "rate": 0.75,
     "desc": "Escarcha frecuente que frena grupos."},
    {"name": "Congelación", "cost": 180, "damage": 20, "rate": 0.7,
     "desc": "Congela por completo a sus objetivos."},
]
TOWERS["venom"]["upgrades"] = [
    {"name": "Veneno Concentrado", "cost": 65, "damage": 12, "poison": {"dps": 12, "t": 3.5},
     "desc": "El veneno corroe mucho más rápido."},
    {"name": "Gas Corrosivo", "cost": 120, "damage": 16, "poison": {"dps": 18, "t": 4}, "aoe": 40,
     "desc": "El vial estalla y envenena en área."},
    {"name": "Peste Negra", "cost": 200, "damage": 24, "poison": {"dps": 28, "t": 5}, "aoe": 52,
     "desc": "Una nube tóxica arrasa grupos enteros."},
]
TOWERS["tesla"]["upgrades"] = [
    {"name": "Arco Doble", "cost": 85, "damage": 28, "chains": 4,
     "desc": "El rayo salta a más enemigos."},
    {"name": "Tormenta Interna", "cost": 150, "damage": 42, "chains": 5, "rate": 0.9,
     "desc": "Más daño y cadenas devastadoras."},
    {"name": "Corona de Rayos", "cost": 240, "damage": 60, "chains": 6, "rate": 0.8,
     "desc": "Una tormenta en miniatura. Ralentiza todo lo que toca."},
]
TOWERS["dwarf"]["upgrades"] = [
    {"name": "Pólvora", "cost": 90, "damage": 80, "rate": 2.3, "aoe": 52,
     "desc": "Más pólvora, más dolor."},
    {"name": "Bombas Pesadas", "cost": 160, "damage": 120, "rate": 2.5, "aoe": 62,
     "desc": "Explosiones que hacen retroceder."},
    {"name": "Catapulta", "cost": 260, "damage": 170, "rate": 2.8, "aoe": 75,
     "desc": "Arrasa tanques y jefes."},
]
TOWERS["crossbow"]["upgrades"] = [
    {"name": "Virote Reforzado", "cost": 80, "damage": 95, "rate": 2.1,
     "desc": "Más daño por disparo."},
    {"name": "Perforación", "cost": 150, "damage": 140, "rate": 2.2, "pierce": 5,
     "desc": "Atraviesa hasta 5 enemigos."},
    {"name": "Ballesta de Asedio", "cost": 240, "damage": 200, "rate": 2.6, "pierce": 6,
     "desc": "Apunta a los jefes y no falla."},
]
TOWERS["druid"]["upgrades"] = [
    {"name": "Raíces", "cost": 70, "rootDur": 1.4, "aura": 1.15,
     "desc": "Inmoviliza más tiempo."},
    {"name": "Curación", "cost": 120, "rootDur": 1.8, "aura": 1.22,
     "desc": "Purga el fuego de las torres aliadas."},
    {"name": "Aura Natural", "cost": 200, "rootDur": 2.2, "aura": 1.3,
     "desc": "Gran aceleración de ataque para sus vecinas."},
]
TOWERS["knight"]["upgrades"] = [
    {"name": "Espadachín", "cost": 80, "damage": 24, "rate": 0.6,
     "desc": "Golpes más fuertes."},
    {"name": "Caballero", "cost": 140, "damage": 36, "rate": 0.55,
     "desc": "Ralentiza a quien golpea."},
    {"name": "Paladín", "cost": 230, "damage": 55, "rate": 0.5,
     "desc": "Aturde brevemente a los enemigos."},
]
TOWERS["holy"]["upgrades"] = [
    {"name": "Luz Bendita", "cost": 100, "damage": 20, "rate": 1.0, "purge": 6,
     "desc": "Purifica más suelo y dispara más rápido."},
    {"name": "Catedral", "cost": 180, "damage": 32, "rate": 0.9, "purge": 9,
     "desc": "Gran purificación y daño sagrado."},
    {"name": "Santo Sepulcro", "cost": 300, "damage": 55, "rate": 0.8, "purge": 14,
     "desc": "Limpia el mapa y destruye a los corruptos."},
]
TOWERS["sniper"]["upgrades"] = [
    {"name": "Balista", "cost": 110, "damage": 140, "rate": 3.4,
     "desc": "Virote reforzado de gran alcance."},
    {"name": "Perforación Blindada", "cost": 190, "damage": 200, "rate": 3.6, "pierce": 3, "ignoreArmor": True,
     "desc": "Ignora la armadura de los enemigos."},
    {"name": "Juez Final", "cost": 300, "damage": 320, "rate": 4.0, "pierce": 4, "ignoreArmor": True,
     "desc": "Un solo disparo puede acabar con un jefe herido."},
]
TOWERS["banner"]["upgrades"] = [
    {"name": "Estandarte de Guerra", "cost": 80, "aura": 1.25, "rateAura": 1.18,
     "desc": "Mayor inspiración para las torres aliadas."},
    {"name": "Bandera Real", "cost": 150, "aura": 1.33, "rateAura": 1.24, "range": 140,
     "desc": "Alcance y poder ampliados."},
    {"name": "Honor de Valdryn", "cost": 240, "aura": 1.45, "rateAura": 1.32, "range": 160,
     "desc": "Las torres cercanas se vuelven leyendas."},
]
TOWERS["warlock"]["upgrades"] = [
    {"name": "Maldición Menor", "cost": 100, "damage": 24, "hex": {"mult": 1.5, "t": 3.5},
     "desc": "La maldición dura más y se intensifica."},
    {"name": "Pacto Oscuro", "cost": 180, "damage": 36, "hex": {"mult": 1.65, "t": 4}, "aoe": 44,
     "desc": "La maldición estalla en área."},
    {"name": "Vacío Devorador", "cost": 280, "damage": 55, "hex": {"mult": 1.85, "t": 5}, "aoe": 55,
     "desc": "Drena el vacío: daña y corrompe el suelo."},
]
TOWERS["barracks"]["upgrades"] = [
    {"name": "Espadachín Veterano", "cost": 70, "soldiers": {"swordsman": {"hp": 130, "dmg": 14, "rate": 0.7, "armor": 1}},
     "desc": "El espadachín se vuelve más fuerte."},
    {"name": "Arquero", "cost": 120, "addArcher": True, "soldiers": {"swordsman": {"hp": 130, "dmg": 14, "rate": 0.7, "armor": 1}, "archer": {"hp": 60, "dmg": 10, "rate": 0.6, "range": 90, "ranged": True}},
     "desc": "Un arquero se une a la defensa."},
    {"name": "Escuadra de Élite", "cost": 200, "addShieldbearer": True, "addMage": True,
     "soldiers": {"swordsman": {"hp": 200, "dmg": 22, "rate": 0.6, "armor": 2}, "archer": {"hp": 90, "dmg": 16, "rate": 0.5, "range": 100, "ranged": True}, "shieldbearer": {"hp": 300, "dmg": 6, "rate": 1.0, "range": 24, "armor": 4}, "mage": {"hp": 70, "dmg": 20, "rate": 1.2, "range": 80, "ranged": True, "element": "fire"}},
...
ENEMIES = {
    ...
    "orcKing": {"name": "Rey Orco", "hp": 1800, "speed": 30, "reward": 350, "r": 20, "color": "#3a6a2a", "boss": True, "armor": 2, "resist": {"physical": 0.5}, "summonType": "goblin", "summonCd": 6, "desc": "Invoca goblins y acelera a los orcos."},
    "lord": {"name": "Señor de los Muertos", "hp": 2200, "speed": 26, "reward": 420, "r": 20, "color": "#3a3a4a", "boss": True, "resist": {"physical": 0.7}, "weak": {"fire": 1.3}, "necro": True, "summonCd": 5, "desc": "Revive a los caídos en esqueletos."},
